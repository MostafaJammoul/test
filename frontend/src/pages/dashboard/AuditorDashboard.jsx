...
export default function AuditorDashboard() {
  ...
  // Fetch assigned investigations
  const { data: investigations, isLoading } = useQuery({
    queryKey: ['investigations', 'assigned'],
    queryFn: async () => {
        ...
        <Card title="My Assigned Investigations">
          {isLoading ? (
            ...
            <div className="text-center py-8">
              <p className="text-gray-600">No investigations assigned to you yet.</p>
              <p className="mt-2 text-sm text-gray-500">
                Contact your administrator to be assigned to cases.
              </p>
            </div>
          )}
        </Card>
          ...
          <Card title="Quick Actions">
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-600">
                You have read-only access to assigned investigations. You can view evidence, blockchain records, and add notes.
              </p>
            </div>
          </Card>
          ...
          <Card title="Permissions">
            <div className="space-y-2 text-sm text-gray-600">
              <div className="flex items-start space-x-2">
                ...
                <span>View assigned investigations (read-only)</span>
              </div>
              <div className="flex items-start space-x-2">
                <svg className="w-5 h-5 text-green-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span>View evidence details and blockchain records</span>
              </div>
              <div className="flex items-start space-x-2">
                <svg className="w-5 h-5 text-green-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span>Add audit notes to investigations</span>
              </div>
              <div className="flex items-start space-x-2">
                <svg className="w-5 h-5 text-red-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
                </svg>
                <span>Cannot download evidence files</span>
              </div>
              <div className="flex items-start space-x-2">
                <svg className="w-5 h-5 text-red-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
                </svg>
                <span>Cannot modify or upload evidence</span>
              </div>
            </div>
          </Card>
        </div>
