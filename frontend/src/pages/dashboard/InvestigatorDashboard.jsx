          ...
          <Card title="Quick Actions">
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-600">
                You have full read/write access to all assigned investigations. You can upload evidence, add notes, and tag cases.
              </p>
            </div>
          </Card>
          ...
          <Card title="Permissions">
            <div className="space-y-2 text-sm text-gray-600">
              <div className="flex items-start space-x-2">
                ...
                <span>View and update assigned investigations</span>
              </div>
              <div className="flex items-start space-x-2">
                <svg className="w-5 h-5 text-green-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span>Upload and download evidence</span>
              </div>
              <div className="flex items-start space-x-2">
                <svg className="w-5 h-5 text-green-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span>Add notes and tags to cases</span>
              </div>
              <div className="flex items-start space-x-2">
