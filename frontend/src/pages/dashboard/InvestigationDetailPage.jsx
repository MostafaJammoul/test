...
export default function InvestigationDetailPage() {
  const { id } = useParams();
  const { isInvestigator, isCourt } = useAuth();
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div>
          ...
          {activeTab === 'evidence' && (
            <EvidenceTab investigation={investigation} canUpload={isInvestigator()} />
          )}
          {activeTab === 'notes' && (
            <NotesTab investigation={investigation} canAdd={isInvestigator()} />
          )}
...
function EvidenceTab({ investigation, canUpload }) {
  return (
    <Card
      title="Evidence Files"
      actions={canUpload && <Button>Upload Evidence</Button>}
    >
...
function NotesTab({ investigation, canAdd }) {
  return (
    <Card title="Investigation Notes" actions={canAdd && <Button>Add Note</Button>}>
