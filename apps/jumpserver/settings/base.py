...
MIDDLEWARE = [
    ...
    # Blockchain Chain of Custody: mTLS certificate authentication
    'authentication.middleware_mtls.MTLSAuthenticationMiddleware',
    ...
    # Blockchain Chain of Custody: Enforce MFA verification for all users
